...
enum {
    ...
    /* output devices */
    AUDIO_DEVICE_OUT_EARPIECE                  = 0x1,       // 1
    AUDIO_DEVICE_OUT_SPEAKER                   = 0x2,       // 10
    AUDIO_DEVICE_OUT_WIRED_HEADSET             = 0x4,       // 100
    AUDIO_DEVICE_OUT_WIRED_HEADPHONE           = 0x8,       // 1000
    AUDIO_DEVICE_OUT_BLUETOOTH_SCO             = 0x10,      // 1 0000
    AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET     = 0x20,      // 10 0000
    AUDIO_DEVICE_OUT_BLUETOOTH_SCO_CARKIT      = 0x40,      // 100 0000
    AUDIO_DEVICE_OUT_BLUETOOTH_A2DP            = 0x80,      // 1000 0000
    AUDIO_DEVICE_OUT_BLUETOOTH_A2DP_HEADPHONES = 0x100,     // 1 0000 0000
    AUDIO_DEVICE_OUT_BLUETOOTH_A2DP_SPEAKER    = 0x200,     // 10 0000 0000
    AUDIO_DEVICE_OUT_AUX_DIGITAL               = 0x400,     // 100 0000 0000
    AUDIO_DEVICE_OUT_ANLG_DOCK_HEADSET         = 0x800,     // 100 0000 00000
    AUDIO_DEVICE_OUT_DGTL_DOCK_HEADSET         = 0x1000,    // 1 0000 0000 0000
    AUDIO_DEVICE_OUT_USB_ACCESSORY             = 0x2000,    // 10 0000 0000 0000
    AUDIO_DEVICE_OUT_USB_DEVICE                = 0x4000,    // 100 0000 0000 0000
    AUDIO_DEVICE_OUT_REMOTE_SUBMIX             = 0x8000,    // 1000 0000 0000 0000
